					  ...
					  const edm::Event& iEvent, const edm::EventSetup& iSetup, const int iJetColl)
{
  ...
  for ( PatJetCollection::const_iterator pjet = jetsColl->begin(); pjet != jetsColl->end(); ++pjet ) {
    ...
    if ( storeCSVTagVariables )
    {
      ...
      std::cout<<vars.get(reco::btau::flightDistance1dVal)<<std::setw(10)<<fabs(vars.get(reco::btau::flightDistance1dVal))<<std::endl;
      ...
      JetInfo[iJetColl].TagVarCSV_AveSip3dVal[JetInfo[iJetColl].nJet]                 = ( vars.checkTag(reco::btau::trackAveSip3dVal) ? fabs(vars.get(reco::btau::trackAveSip3dVal)) : -9999 );
      JetInfo[iJetColl].TagVarCSV_AveSip3dSig[JetInfo[iJetColl].nJet]                 = ( vars.checkTag(reco::btau::trackAveSip3dSig) ? vars.get(reco::btau::trackAveSip3dSig) : -9999 );
      JetInfo[iJetColl].TagVarCSV_AveSip2dVal[JetInfo[iJetColl].nJet]                 = ( vars.checkTag(reco::btau::trackAveSip2dVal) ? vars.get(reco::btau::trackAveSip2dVal) : -9999 );
      JetInfo[iJetColl].TagVarCSV_AveSip2dSig[JetInfo[iJetColl].nJet]                 = ( vars.checkTag(reco::btau::trackAveSip2dSig) ? vars.get(reco::btau::trackAveSip2dSig) : -9999 );
      JetInfo[iJetColl].TagVarCSV_AveSip1dVal[JetInfo[iJetColl].nJet]                 = ( vars.checkTag(reco::btau::trackAveSip1dVal) ? vars.get(reco::btau::trackAveSip1dVal) : -9999 );
      JetInfo[iJetColl].TagVarCSV_AveSip1dSig[JetInfo[iJetColl].nJet]                 = ( vars.checkTag(reco::btau::trackAveSip1dSig) ? vars.get(reco::btau::trackAveSip1dSig) : -9999 );
